...
$mysql_cmd  "INSERT INTO ${db_server}combat_info (operator_steamid, operator_nickname, action, target_steamid, target_nickname, weapon, action_time ,health) VALUES ('$operator_steamid', '$operator_nickname', 'Die', '$target_steamid', '$target_nickname', '$weapon', '$action_time', '$damage')"
